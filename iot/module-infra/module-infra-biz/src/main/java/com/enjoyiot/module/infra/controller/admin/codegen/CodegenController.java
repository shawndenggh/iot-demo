 ...
 * /
 */
package com.enjoyiot.module.infra.controller.admin.codegen;
...
import com.enjoyiot.module.infra.convert.codegen.CodegenConvert;
...
import com.enjoyiot.module.infra.service.codegen.CodegenService;
...
import static com.enjoyiot.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "Enjoy"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "test")
    })
