...
import com.enjoyiot.module.system.convert.oauth2.OAuth2OpenConvert;
...
import com.enjoyiot.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import com.enjoyiot.module.system.service.oauth2.OAuth2ApproveService;
import com.enjoyiot.module.system.service.oauth2.OAuth2ClientService;
import com.enjoyiot.module.system.service.oauth2.OAuth2GrantService;
...
import static com.enjoyiot.framework.common.exception.util.ServiceExceptionUtil.exception0;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "http://www.enjoy-iot.cn"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "http://www.enjoy-iot.cn"),
