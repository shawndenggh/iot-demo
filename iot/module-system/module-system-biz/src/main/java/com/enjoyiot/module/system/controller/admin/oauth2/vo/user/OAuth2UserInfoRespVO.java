 ...
 * /
 */
package com.enjoyiot.module.system.controller.admin.oauth2.vo.user;
...
public class OAuth2UserInfoRespVO {
    ...
    @Schema(description = "用户账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "test")
    private String username;

    @Schema(description = "用户昵称", requiredMode = Schema.RequiredMode.REQUIRED, example = "test")
    private String nickname;

    @Schema(description = "用户邮箱", example = "enjoy@enjoy-iot.cn")
    private String email;
    @Schema(description = "手机号码", example = "1888888888")
