...
import com.enjoyiot.module.system.dal.mysql.social.SocialClientMapper;
...
import static com.enjoyiot.framework.common.util.collection.MapUtils.findAndThen;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${platform.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${platform.wxa-subscribe-message.miniprogram-state:formal}")
