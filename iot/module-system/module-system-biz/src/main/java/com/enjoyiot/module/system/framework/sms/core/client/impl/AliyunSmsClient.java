...
import com.enjoyiot.module.system.framework.sms.core.enums.SmsTemplateAuditStatusEnum;
    ...
    public List<SmsReceiveRespDTO> parseSmsReceiveStatus(String text) {
        ...
        return convertList(statuses, status -> {
            ...
            return SmsReceiveRespDTO.builder()
                    .success(statusObj.getBool("success")) // 是否接收成功
                    .errorCode(statusObj.getStr("err_code")) // 状态报告编码
                    .errorMsg(statusObj.getStr("err_msg")) // 状态报告说明
                    .mobile(statusObj.getStr("phone_number")) // 手机号
                    .receiveTime(statusObj.getLocalDateTime("report_time", null)) // 状态报告时间
                    .serialNo(statusObj.getStr("biz_id")) // 发送序列号
                    .logId(statusObj.getLong("out_id")).build(); // 用户序列号
        });
    }
