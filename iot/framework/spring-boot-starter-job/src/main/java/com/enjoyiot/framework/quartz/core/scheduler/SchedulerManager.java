 ...
 * /
 */
package com.enjoyiot.framework.quartz.core.scheduler;

import com.enjoyiot.framework.quartz.core.enums.JobDataKeyEnum;
import com.enjoyiot.framework.quartz.core.handler.JobHandlerInvoker;
import org.quartz.*;

import static com.enjoyiot.framework.common.exception.enums.GlobalErrorCodeConstants.NOT_IMPLEMENTED;
    ...
    private void validateScheduler() {
        if (scheduler == null) {
            throw exception0(NOT_IMPLEMENTED.getCode(),
                    "[定时任务 - 已禁用][参考 http://doc.enjoy-iot.cn/job/ 开启]");
        }
    }
