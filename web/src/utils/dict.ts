...
export enum DICT_TYPE {
  ...
  COMMON_BOOLEAN_INT = 'common_boolean_int',
  ...
  // ========== EIOT物联网模块  ==========
  EIOT_NODE_TYPE = 'eiot_node_type', // 设备类型
  EIOT_PROTOCOL_CODE = 'eiot_protocol_code', // 协议
  EIOT_DN_TYP = 'eiot_dn_typ', // 唯一标识类型

  EIOT_DEVICE_STATUS = 'eiot_device_status', // 设备生命周期状态
  EIOT_SHOW_MODEL_TYP = 'eiot_show_model_typ', // 设备生命周期状态

  EIOT_MUC_CODE = 'eiot_mcu_code', // 芯片类型编码
//   视频模块
  EIOT_VIDEO_TYPE = 'video_type',
  EIOT_CHANNEL_TYPE = 'channel_type',

  SIP_GEN_STATUS= 'sip_gen_status',
}
