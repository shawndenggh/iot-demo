  ...
  >
    <el-form v-if="state.dialogShow" ref="productModelFormRef" :model="productModelForm" :rules="state.scriptRules" label-width="80px">
      ...
      <el-form-item label="脚本" prop="script" class="product-script">
        ...
        <div style="width: 100%">
          <code-editor v-if="productModelForm.type === 'JavaScript'" mode="text/javascript" v-model:code="productModelForm.script"/>
          <code-editor v-if="productModelForm.type === 'LuaScript'" mode="text/x-lua" v-model:code="productModelForm.script"/>
        </div>
      </el-form-item>
      <el-form-item>
