...
import BindDevices from './modules/bindDevices.vue'
import DeviceLog from './modules/log.vue'
import ScriptBox from './modules/script.vue'
import { ElNotification } from 'element-plus'

import { setVirtualDeviceState, runVirtualDevices, getVirtualDevicesDetail } from '@/api/eiot/deviceinfo/virtualDevices.api'
