...
import { getDevices, upgradeUpgradePack } from '@/api/eiot/ota/upgradePack.api'
...
const filterMethod = (query, item) => {
  return item.dn.toLowerCase().includes(query.toLowerCase())
}
const handleClose = () => {
  state.visible = false
}
