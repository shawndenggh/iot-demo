...
<!--          class="!w-240px"-->
<!--        >-->
<!--          <el-option v-for="dict in getIntDictOptions(DICT_TYPE.COMMON_BOOLEAN_INT)"-->
<!--                     :key="dict.value"-->
<!--                     :label="dict.label"-->
<!--                     :value="dict.value" />-->
<!--        </el-select>-->
...
<!--        <template #default="scope">-->
<!--          <dict-tag :type="DICT_TYPE.COMMON_BOOLEAN_INT" :value="scope.row.isSys" />-->
<!--        </template>-->
<!--      </el-table-column>-->
...
const handleExport = async () => {
  try {
    ...
    download.excel(data, 'IOT产品分类.xls')
  } catch {
  } finally {
